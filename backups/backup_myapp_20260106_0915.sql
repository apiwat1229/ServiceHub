...
\restrict dQSxBIc3A272g66hwynNmuA6fndc3AkB9e6VybzlZrgpzqzP9a4HCx891ErHlwH
...
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_hod_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_app_permissions DROP CONSTRAINT IF EXISTS user_app_permissions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.suppliers DROP CONSTRAINT IF EXISTS suppliers_subdistrict_id_fkey;
ALTER TABLE IF EXISTS ONLY public.suppliers DROP CONSTRAINT IF EXISTS suppliers_province_id_fkey;
ALTER TABLE IF EXISTS ONLY public.suppliers DROP CONSTRAINT IF EXISTS suppliers_district_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subdistricts DROP CONSTRAINT IF EXISTS subdistricts_district_id_fkey;
ALTER TABLE IF EXISTS ONLY public.printer_user_mappings DROP CONSTRAINT IF EXISTS printer_user_mappings_department_id_fkey;
ALTER TABLE IF EXISTS ONLY public.printer_usage_records DROP CONSTRAINT IF EXISTS printer_usage_records_department_id_fkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS "posts_authorId_fkey";
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.knowledge_books DROP CONSTRAINT IF EXISTS knowledge_books_uploaded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.districts DROP CONSTRAINT IF EXISTS districts_province_id_fkey;
ALTER TABLE IF EXISTS ONLY public.booking_lab_samples DROP CONSTRAINT IF EXISTS booking_lab_samples_booking_id_fkey;
ALTER TABLE IF EXISTS ONLY public.book_views DROP CONSTRAINT IF EXISTS book_views_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.book_views DROP CONSTRAINT IF EXISTS book_views_book_id_fkey;
ALTER TABLE IF EXISTS ONLY public.approval_requests DROP CONSTRAINT IF EXISTS approval_requests_requester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.approval_requests DROP CONSTRAINT IF EXISTS approval_requests_approver_id_fkey;
ALTER TABLE IF EXISTS ONLY public.approval_logs DROP CONSTRAINT IF EXISTS approval_logs_approval_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public."_NotificationGroupMembers" DROP CONSTRAINT IF EXISTS "_NotificationGroupMembers_B_fkey";
ALTER TABLE IF EXISTS ONLY public."_NotificationGroupMembers" DROP CONSTRAINT IF EXISTS "_NotificationGroupMembers_A_fkey";
DROP INDEX IF EXISTS public.users_username_key;
DROP INDEX IF EXISTS public.users_employee_id_key;
DROP INDEX IF EXISTS public.users_email_key;
DROP INDEX IF EXISTS public."user_app_permissions_user_id_appName_key";
DROP INDEX IF EXISTS public.suppliers_deleted_at_idx;
DROP INDEX IF EXISTS public.suppliers_code_key;
DROP INDEX IF EXISTS public.subdistricts_code_key;
DROP INDEX IF EXISTS public.rubber_types_deleted_at_idx;
DROP INDEX IF EXISTS public.rubber_types_code_key;
DROP INDEX IF EXISTS public.roles_name_key;
DROP INDEX IF EXISTS public.provinces_code_key;
DROP INDEX IF EXISTS public.printer_user_mappings_user_name_key;
DROP INDEX IF EXISTS public.printer_usage_records_period_user_name_key;
DROP INDEX IF EXISTS public.printer_departments_name_key;
DROP INDEX IF EXISTS public."posts_authorId_idx";
DROP INDEX IF EXISTS public.notifications_user_id_idx;
DROP INDEX IF EXISTS public.notifications_approval_request_id_idx;
DROP INDEX IF EXISTS public."notification_settings_sourceApp_actionType_key";
DROP INDEX IF EXISTS public.knowledge_books_uploaded_by_idx;
DROP INDEX IF EXISTS public.knowledge_books_is_published_idx;
DROP INDEX IF EXISTS public.knowledge_books_category_idx;
DROP INDEX IF EXISTS public.districts_code_key;
DROP INDEX IF EXISTS public.bookings_deleted_at_idx;
DROP INDEX IF EXISTS public.bookings_date_slot_idx;
DROP INDEX IF EXISTS public.bookings_booking_code_key;
DROP INDEX IF EXISTS public.bookings_booking_code_idx;
DROP INDEX IF EXISTS public.book_views_user_id_idx;
DROP INDEX IF EXISTS public.book_views_book_id_idx;
DROP INDEX IF EXISTS public.approval_requests_status_idx;
DROP INDEX IF EXISTS public.approval_requests_requester_id_idx;
DROP INDEX IF EXISTS public.approval_requests_entity_type_entity_id_idx;
DROP INDEX IF EXISTS public.approval_requests_approver_id_idx;
DROP INDEX IF EXISTS public.approval_logs_approval_request_id_idx;
DROP INDEX IF EXISTS public.approval_logs_actor_id_idx;
DROP INDEX IF EXISTS public."_NotificationGroupMembers_B_index";
DROP INDEX IF EXISTS public."_NotificationGroupMembers_AB_unique";
DROP INDEX IF EXISTS public."NotificationGroup_name_key";
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.user_app_permissions DROP CONSTRAINT IF EXISTS user_app_permissions_pkey;
ALTER TABLE IF EXISTS ONLY public.suppliers DROP CONSTRAINT IF EXISTS suppliers_pkey;
ALTER TABLE IF EXISTS ONLY public.subdistricts DROP CONSTRAINT IF EXISTS subdistricts_pkey;
ALTER TABLE IF EXISTS ONLY public.rubber_types DROP CONSTRAINT IF EXISTS rubber_types_pkey;
ALTER TABLE IF EXISTS ONLY public.roles DROP CONSTRAINT IF EXISTS roles_pkey;
ALTER TABLE IF EXISTS ONLY public.provinces DROP CONSTRAINT IF EXISTS provinces_pkey;
ALTER TABLE IF EXISTS ONLY public.printer_user_mappings DROP CONSTRAINT IF EXISTS printer_user_mappings_pkey;
ALTER TABLE IF EXISTS ONLY public.printer_usage_records DROP CONSTRAINT IF EXISTS printer_usage_records_pkey;
ALTER TABLE IF EXISTS ONLY public.printer_departments DROP CONSTRAINT IF EXISTS printer_departments_pkey;
...
ALTER TABLE IF EXISTS ONLY public.knowledge_books DROP CONSTRAINT IF EXISTS knowledge_books_pkey;
...
ALTER TABLE IF EXISTS ONLY public.booking_lab_samples DROP CONSTRAINT IF EXISTS booking_lab_samples_pkey;
ALTER TABLE IF EXISTS ONLY public.book_views DROP CONSTRAINT IF EXISTS book_views_pkey;
ALTER TABLE IF EXISTS ONLY public.approval_requests DROP CONSTRAINT IF EXISTS approval_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.approval_logs DROP CONSTRAINT IF EXISTS approval_logs_pkey;
ALTER TABLE IF EXISTS ONLY public._prisma_migrations DROP CONSTRAINT IF EXISTS _prisma_migrations_pkey;
ALTER TABLE IF EXISTS ONLY public."NotificationGroup" DROP CONSTRAINT IF EXISTS "NotificationGroup_pkey";
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.user_app_permissions;
DROP TABLE IF EXISTS public.suppliers;
DROP TABLE IF EXISTS public.subdistricts;
DROP TABLE IF EXISTS public.rubber_types;
DROP TABLE IF EXISTS public.roles;
DROP TABLE IF EXISTS public.provinces;
DROP TABLE IF EXISTS public.printer_user_mappings;
DROP TABLE IF EXISTS public.printer_usage_records;
DROP TABLE IF EXISTS public.printer_departments;
DROP TABLE IF EXISTS public.posts;
DROP TABLE IF EXISTS public.notifications;
DROP TABLE IF EXISTS public.notification_settings;
DROP TABLE IF EXISTS public.knowledge_books;
DROP TABLE IF EXISTS public.districts;
DROP TABLE IF EXISTS public.bookings;
DROP TABLE IF EXISTS public.booking_lab_samples;
DROP TABLE IF EXISTS public.book_views;
DROP TABLE IF EXISTS public.approval_requests;
DROP TABLE IF EXISTS public.approval_logs;
DROP TABLE IF EXISTS public._prisma_migrations;
DROP TABLE IF EXISTS public."_NotificationGroupMembers";
DROP TABLE IF EXISTS public."NotificationGroup";
...
COPY public.printer_usage_records (id, period, user_name, department_id, print_bw, print_color, copy_bw, copy_color, total, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: printer_usage_records_period_user_name_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX printer_usage_records_period_user_name_key ON public.printer_usage_records USING btree (period, user_name);
...
\unrestrict dQSxBIc3A272g66hwynNmuA6fndc3AkB9e6VybzlZrgpzqzP9a4HCx891ErHlwH
