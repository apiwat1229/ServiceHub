...
import type { GLCode } from '@/composables/useMaintenance';
import {
  FlexRender,
  getCoreRowModel,
  getFilteredRowModel,
...
const columns: ColumnDef<GLCode>[] = [
  {
    ...
    header: () => t('services.maintenance.glCodes.transactionId'),
    cell: ({ row }) => {
      return h(
        'span',
  ...
  },
  {
    ...
    header: () => t('services.maintenance.glCodes.description'),
    cell: ({ row }) => {
  ...
  {
    accessorKey: 'code',
    header: () => h('div', { class: 'text-left' }, t('services.maintenance.glCodes.code')),
    cell: ({ row }) => {
      return h(
        'div',
  ...
  {
    accessorKey: 'purpose',
    header: () => t('services.maintenance.glCodes.purpose'),
    cell: ({ row }) => {
  ...
  <div class="space-y-4">
    ...
    <div class="relative max-w-sm">
      ...
      <Input
        ...
        :placeholder="t('services.maintenance.glCodes.searchPlaceholder')"
