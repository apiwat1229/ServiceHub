...
function returnResults(it) {
  ...
  if (schemaEnv.$async) {
    gen.if((0, codegen_1$N._)`${names_1$7.default.errors} === 0`, () => gen.return(names_1$7.default.data), () => gen.throw((0, codegen_1$N._)`new ${ValidationError2}(${names_1$7.default.vErrors})`));
  } else {
